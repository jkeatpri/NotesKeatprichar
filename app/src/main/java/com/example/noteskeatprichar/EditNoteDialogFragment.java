...
public class EditNoteDialogFragment extends DialogFragment{
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setMessage("Edit " + note).setView(inflater.inflate(R.layout.editdialog_layout, null)).setPositiveButton("EDIT", new DialogInterface.OnClickListener(){
            @Override
    ...
    public void show(String keatprichar) {
    }
